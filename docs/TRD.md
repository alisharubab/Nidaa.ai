...
**Matching cascade:**
1. **Exact normalised match** after lowercasing, stripping diacritics and collapsing whitespace. Method `exact`, score 1.0.
2. **Alias lookup.** `data/aliases.json` maps hand-curated Roman Urdu variants for the top 40 flood-affected districts: `{"daadu":"Dadu","dadoo":"Dadu","ڈاڈو":"Dadu","sakkhar":"Sukkur","khairpoor":"Khairpur", ...}`. Method `alias`, score 1.0.
